...
export const en: Dict = {
  ...
  services: {
    ...
    items: {
      ...
      diaCompleto: 'Full-day coverage, instead of 8 hours',
      fotosTodas: 'Every selected photograph, with no fixed number',
      ...
      sessao1h: 'One hour, at one location',
      sessao2h: 'Two-hour session',
      doisAmbientes: 'Two settings, or two changes of outfit',
