...
const ROTAS = [
  ...
  '/sobre',
  '/servicos',
  // Um por serviço: são páginas próprias, com título e descrição próprios, e
  // quem lê o HTML sem correr JavaScript tem de as ver assim.
  '/servicos/casamentos',
  ...
  '/en/services/maternity',
  '/en/services/portraits',
  '/en/services/events',
  '/en/portfolio',
  '/en/contact',
  '/en/privacy',
